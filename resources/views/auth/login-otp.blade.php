...
<head>
    ...
    <title>Verify Login OTP - WhatsApp Campaign Platform</title>
            ...
            <div class="col-md-5 col-lg-4">
                <div class="auth-card">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="mt-3 mb-1" data-en="Login Verification" data-ar="تأكيد الدخول">Login Verification
                        </h2>
                        <p class="text-muted" data-en="Enter the code sent to your WhatsApp"
                            data-ar="أدخل الرمز المرسل إلى تطبيق الواتساب الخاص بك">Enter the code sent to your WhatsApp
                        </p>
                        <div class="d-flex justify-content-center align-items-center gap-2 mb-2">
                            <p class="fw-semibold text-primary mb-0" id="phoneDisplay" dir="ltr">{{ $phone }}</p>
                            <a href="{{ route('login') }}" class="btn btn-sm btn-outline-secondary p-1 lh-1"
                    ...
                    <form method="POST" action="{{ route('verify.otp.post') }}" onsubmit="combineOtp()">
                        ...
                        <div class="text-center mb-4">
                            ...
                            <a href="{{ route('resend.otp') }}" class="btn btn-link text-decoration-none p-0 disabled"
                                id="resendBtn">
                        ...
                        <button type="submit" class="btn btn-primary w-100 mb-3">
                            ...
                            <span data-en="Verify & Login" data-ar="تحقق وتسجيل الدخول">Verify & Login</span>
                        </button>
